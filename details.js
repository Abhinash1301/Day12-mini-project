  ...
  return (
    <div>
      <div className="aboutpage">
        <div>
          <h3 className="firstjanu">Google</h3>
          ...
          <h3 className="fadeInUp2"><img src="https://cdn-icons-png.flaticon.com/128/2830/2830566.png" className='book2'></img>Salary<br></br>$70l/yr</h3>
          <h3 className="fadeInUp3"><img src="https://cdn-icons-png.flaticon.com/128/535/535239.png" className='book3'></img>Location<br></br>Hydreabad,Telangana</h3>
...
3. Master’s degree.</p>
          ...
          <button onClick={handleReadMoreClick} className="button-307">Job Description</button>
        </div>
        <div>
          <img
            className="phonesee"
            src="https://i.pinimg.com/736x/39/21/6d/39216d73519bca962bd4a01f3e8f4a4b.jpg"
            height="580px"
            width="580px"
            alt=""
          />
